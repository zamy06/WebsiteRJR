    ...
    <section class="banner-Crewneck">
     ...
     <div class="container-fluid pt-0 pb-5 bg-light">
        <div class="container text-center">
          <h2 class="display-3" id="portofolio">Produk Crewneck</h2>
          <p>
          ...
          <!-- card 2 -->
            <div class="col-md-4">
              <div class="card crop-img shadow-sm">
                <img
                  src="foto/crewneck bloods2.webp"
                  class="card-img-top custom-img" 
                  alt="Crewneck Bloods"
                />
                <div class="card-body">
            ...
            <div class="col-md-4">
              <div class="card crop-img shadow-sm">
                <img
                  src="foto/crewneck bloods4.webp"
                  class="card-img-top custom-img"
                  alt=" Crewneck Bloods"
                />
                <div class="card-body">
            ...
            <div class="col-md-4">
              <div class="card crop-img shadow-sm">
                <img
                  src="foto/crewneck bloods5.webp"
                  class="card-img-top custom-img"
                  alt="Crewneck Bloods"
                />
                <div class="card-body">
