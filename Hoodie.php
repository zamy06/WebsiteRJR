    ...
    <section class="banner-hoodie">
     ...
     <div class="container-fluid pt-0 pb-5 bg-light">
        <div class="container text-center">
          <h2 class="display-3" id="portofolio">Produk Hoodie</h2>
          <p>
            ...
            <div class="col-md-4">
              <div class="card crop-img shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Hoodie Bloods pakaian hangat yang dirancang untuk memberikan kenyamanan. 
                  </p>
