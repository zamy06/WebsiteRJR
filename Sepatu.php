    ...
    <section class="banner-sepatu">
     ...
     <div class="container-fluid pt-0 pb-5 bg-light">
        <div class="container text-center">
          <h2 class="display-3" id="portofolio">Produk Sepatu</h2>
          <p>
            ...
            <div class="col-md-4">
              <div class="card crop-img shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Sepatu Ventela yaitu produk lokal Indonesia yang dikenal dengan kualitas premium.
                  </p>
                  <h6 class="text-primary text-danger">Rp 250.000</h6>
